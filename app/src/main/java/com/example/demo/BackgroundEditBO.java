...
public class BackgroundEditBO extends AsyncTask<String,Void,String> {


    Context context;
    BackgroundEditBO(Context ctx){context=ctx;}
    ...
    protected String doInBackground(String... strings) {
        ...
        String update_url="http://10.0.2.2/Android/files/updateProfileBO.php";
        if (type.equals("updateProfileBO")){
