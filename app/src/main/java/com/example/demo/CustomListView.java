...
public class CustomListView extends ArrayAdapter<String> {
    ...
    public CustomListView(@NonNull Context context, String[] profilename,String[] email,String[] imagepath) {
        super(context, R.layout.layout_row,profilename);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
      ...
      if (r==null){
          ...
          r=layoutInflater.inflate(R.layout.layout_row,null,true);
