...
public class DeliverOrderBoarder extends AppCompatActivity {


    String  emailShared;
    private static final String apiurl="http://10.0.2.2/Android/files/selectDeliveryFoodB.php";
    ListView lv;
    String Oid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_deliver_order_boarder);
...
//                        order_type[i]=jo.getString("order_type");
                    ...
                    myadapter adptr = new myadapter(getApplicationContext(),order_id,expireTime,shedule, address,restaurant,phone,total,method);
...
//        String order_type[];
        ...
        myadapter(Context c, String order_id[],String expireTime[],String shedule[], String address[],String restaurant[], String phone[],String total[],String method[])
        {
            super(c,R.layout.catd_del_food_boarder,R.id.order_id,order_id);
            context=c;
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent)
        {
            ...
            View row=inflater.inflate(R.layout.catd_del_food_boarder,parent,false);
...
//            });
            btnAccept.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(DeliverOrderBoarder.this,ViewDeliveryOrder.class);
                ...
                public void onClick(View v) {
                    ...
                    alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent=new Intent(DeliverOrderBoarder.this,ConfirmDelOrderB.class);
                            intent.putExtra("order_id",order_id[position]);
                            Toast.makeText(getApplicationContext(),emailShared, Toast.LENGTH_LONG).show();
                            startActivity(intent);
                        }
