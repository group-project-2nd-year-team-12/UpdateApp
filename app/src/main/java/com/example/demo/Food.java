...
public class Food extends AppCompatActivity {
  ...
  //  String  emailShared;
    private static final String apiurl="http://10.0.2.2/Android/files/food.php";
    ListView lv;
...
//                    profile = new String[ja.length()];
                    ...
                    for (int i = 0; i < ja.length(); i++) {
                        ...
                        email[i] = jo.getString("ad_title");
                        first_name[i] = jo.getString("description");
...
//                        profile[i] ="http://10.0.2.2/Android/files/" + jo.getString("image");;
                    ...
                    myadapter adptr = new myadapter(getApplicationContext(),email,first_name);
                    lv.setAdapter(adptr);
...
//        String profile[];
        ...
        myadapter(Context c,String email[],String first_name[])
        {
            super(c,R.layout.list_prac,R.id.ishan,email);
            context=c;
            this.email=email;
...
//            this.profile=profile;
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent)
        {
            ...
            View row=inflater.inflate(R.layout.list_prac,parent,false);

            //ImageView img=row.findViewById(R.id.img1);


            TextView txtemail=row.findViewById(R.id.ishan);
            TextView txtname=row.findViewById(R.id.reshmika);
...
//            TextView txttitlt=row.findViewById(R.id.title);
          ...
          //  String url=profile[position];
            txtname.setText(first_name[position]);
