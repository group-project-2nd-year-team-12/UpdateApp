...
public class LunchFood extends AppCompatActivity {
    private static final String apiurl="http://10.0.2.2/Android/files/selectFoodL.php";
    ListView lv;
    TextView txt;
    String F_post_id;
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent)
        {
            ...
            btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AlertDialog.Builder alert=new AlertDialog.Builder(LunchFood.this);
                    alert.setMessage("Do you want to order "+product_name[position]+"? ").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(getApplicationContext(),"You can add that item",Toast.LENGTH_LONG).show();
                            Intent intent=new Intent(LunchFood.this,InsideFoodPost.class);
