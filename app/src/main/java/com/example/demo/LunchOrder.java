...
public class LunchOrder extends AppCompatActivity {


    String  emailShared;
    private static final String apiurl="http://10.0.2.2/Android/files/selectSFoodOrderL.php";
    ListView lv;
    String Oid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv=(ListView)findViewById(R.id.listfoodL);
...
//            });
            btnAccept.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(LunchOrder.this,viewOrdersShort.class);
