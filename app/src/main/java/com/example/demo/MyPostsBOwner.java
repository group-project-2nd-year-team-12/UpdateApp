...
//                startActivity(intent);
            ...
            case R.id.item2:
                ...
                AlertDialog.Builder alert=new AlertDialog.Builder(MyPostsBOwner.this);
                alert.setMessage("Are you want to logout?").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (sharedPreferences.contains("username")){
                            SharedPreferences.Editor editor=sharedPreferences.edit();
                            editor.remove("username");
                            Intent intent1=new Intent(MyPostsBOwner.this,MainActivity.class);
                            startActivity(intent1);
                            Toast.makeText(MyPostsBOwner.this,"Succesfully Logout",Toast.LENGTH_LONG).show();
                        }
                    }
