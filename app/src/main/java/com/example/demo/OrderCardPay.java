...
public class OrderCardPay extends AppCompatActivity {


    String  emailShared;
    private static final String apiurl="http://10.0.2.2/Android/files/selectPendingFood.php";
    ListView lv;
    String Oid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_order_card_pay);
...
//        String order_type[];
        ...
        {
            super(c,R.layout.card_pending_food_orders,R.id.order_id,order_id);
            context=c;
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent)
        {
            ...
            View row=inflater.inflate(R.layout.card_pending_food_orders,parent,false);
...
//            });
            btnAccept.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(OrderCardPay.this,ViewDeliveryOrder.class);
