...
public class my_post_BO extends AppCompatActivity {
  ...
  //  private static String image[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_post__b_o);
            ...
            protected void onPostExecute(String data)
            {
                ...
                //   image = new String[ja.length()];
                    ...
                    for (int i = 0; i < ja.length(); i++) {
                      ...
                      //  image[i] ="http://10.0.2.2/Android/resource/Images/uploaded_boarding/" + jo.getString("image");;
                    }

                    myadapter adptr = new myadapter(getApplicationContext(), lane, city);
                    lv.setAdapter(adptr);
    ...
    class myadapter extends ArrayAdapter<String>
    {
     ...
     //  String rimg[];
        ...
        {
            super(c,R.layout.single_row_profile,R.id.name,ttl);
            context=c;
         //   this.rimg=rimg;
            this.ttl=ttl;
            this.dsc=dsc;
